class initAudioPlayerParams:
    def __init__(self):
        ...
        self.chunk_database = r"P:\Program Files\Python313\AI_assistance\GitModel\AI_assistant\Source\Database\chroma_db"
        self.inputJSON = r"P:\Program Files\Python313\AI_assistance\GitModel\AI_assistant\Database\reversed_word.jsonl"

        # Wake up model
        self.wake_up_model_path = r"P:\Program Files\Python313\AI_assistance\GitModel\AI_assistant\models\hey_jarvis_v0.1.onnx"
        self.accuracy_wake_up = 0.5

        # voice active
        self.voice_output_path = r"P:\Program Files\Python313\AI_assistance\GitModel\AI_assistant\Audio\voice"

        # model transcript
        self.transcriptPath = r"P:\Program Files\Python313\AI_assistance\GitModel\AI_assistant\PhoWhisper-tiny"
